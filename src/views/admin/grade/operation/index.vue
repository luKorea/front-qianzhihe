            ...
            <el-row :gutter="4">
              <el-col :span="10">
                <el-form-item label="班主任">
                  <el-select filterable v-model="form.teacherId"
                             placeholder="请选择" style="width: 100%" :clearable="true" :filterable="true">
              ...
              <el-col :span="10">
                <el-form-item label="生涯导师1">
                  <el-select v-model="form.teacher1Id" placeholder="请选择"
                             :clearable="true" :filterable="true"
                             style="width: 100%">
            ...
            <el-row :gutter="4">
              <el-col :span="10">
                <el-form-item label="生涯导师2">
                  <el-select v-model="form.teacher2Id" placeholder="请选择"
                             :clearable="true" :filterable="true"
                             style="width: 100%">
