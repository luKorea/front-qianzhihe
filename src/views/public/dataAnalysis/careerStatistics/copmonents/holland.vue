  ...
  <div style="display: flex">
    <div class="charts-wrap" style="width: 60%">
      <div class="percent-wrap">
        <div class="tip-title m-bottom">兴趣测试完成率</div>
        <el-progress :percentage="90"
                     :stroke-width="12"
                     :format="format"
                     type="circle" class="m-bottom"></el-progress>
        <div class="info">
      ...
      <div id="holland-charts" style="width: 100%; height: 300px"></div>
    </div>
    <div class="tip">
...
export default {
  ...
  methods: {
    ...
    initCharts() {
      this.charts = this.$echarts.init(document.getElementById('holland-charts'));
