                    ...
                    <div class="vicp-crop-left" v-show="true">
                        <div class="vicp-img-container">
                            <img :src="sourceImgUrl" :style="sourceImgStyle" class="vicp-img" draggable="false" @drag="preventDefault" @dragstart="preventDefault" @dragend="preventDefault"
                                @dragleave="preventDefault" @dragover="preventDefault" @dragenter="preventDefault" @drop="preventDefault" @touchstart="imgStartMove" @touchmove="imgMove"
                                @touchend="createImg" @touchcancel="createImg" @mousedown="imgStartMove" @mousemove="imgMove" @mouseup="createImg" @mouseout="createImg" @mousewheel="imgWheel"
                                ref="img">
                        ...
                        <div class="vicp-range">
                            <input type="range" :value="scale.range" step="1" min="-100" max="100" @input="zoomChange">
...
export default {
  ...
  methods: {
    ...
    zoomImg(newRange) {
      ...
      // 新宽高
      const nWidth = minWidth + Math.abs(maxWidth - minWidth) * newRange / 100
      const nHeight = minHeight + Math.abs(maxHeight - minHeight) * newRange / 100

      // 新坐标（根据蒙版中心点缩放）
      // let nX = sWidth / 2 - (nWidth / width) * (sWidth / 2 - x)
      // let nY = sHeight / 2 - (nHeight / height) * (sHeight / 2 - y)
      let nX = (sWidth - nWidth) / 2;
      let nY = (sHeight - nHeight) / 2;
    ...
    prepareUpload() {
      ...
      if (typeof url === 'string' && url) {
        ...
        this.$emit('crop-upload-success', createImgUrl)
      } else {
        this.off()
      }
    },
